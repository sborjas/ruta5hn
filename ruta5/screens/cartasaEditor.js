...
export default class cartasaEditor extends React.Component {
    render(){
        return(
            <Container>
                ...
                <Body>
                    <Title>Cartas al Editor</Title>
                </Body>
                </Header>
                <WebView source={{uri: 'https://rutacincohn.com/category/cartas-al-editor/'}}/>
